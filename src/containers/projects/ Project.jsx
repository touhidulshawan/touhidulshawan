...
const Project = (props) => {
  ...
  return (
    <div className="grid grid-cols-5 gap-2 my-3 py-2 px-3 content-center bg-gray-200 mx-2 rounded-lg shadow-lg border-b-4 border-r-8 border-t-2 border-l-2 border-gray-700">
